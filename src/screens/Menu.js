...
const Menu = () => {
    ...
    const onShareApp = async () => {
        Share.share({
            message: `Baixe 'O Sábio' na Play Store: ` + 'https://play.google.com/store/apps/details?id=com.sabio'
        })
    }
    ...
    const onShareRate = async () => {
        ...
        const url = 'https://play.google.com/store/apps/details?id=com.sabio';
    ...
    const onShareFeedback = async () => {
        ...
        const url = 'mailto:bgomes107fox@gmail.com?subject=O Sábio - Feedback';
        const supported = await Linking.canOpenURL(url);
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: theme == false ? '#e9e9e9' : '#191919', justifyContent: 'center' }}>
            <ScrollView>
